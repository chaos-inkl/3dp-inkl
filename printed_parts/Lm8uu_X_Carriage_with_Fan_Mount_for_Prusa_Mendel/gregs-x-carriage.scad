...
gregs_x_carriage();
*for(i=[-1,1])
translate([25*i,0,15/2+lm8uu_support_thickness])
rotate(a=90,v=[1,0,0])
cylinder(d=15,h=80,center=true);
//y_axis_holder ();
module holder_a(){


    translate([0,-35,15/2+lm8uu_support_thickness*4.25])
    difference(){
     minkowski(){
            cube([70,10,lm8uu_support_thickness*2],center=true);
                cylinder(d=5,h=0.001);
            }
            for(j=[-1,1])
                translate([13*j,0,1.6]){
     ...
     minkowski(){
            cube([70,10,lm8uu_support_thickness*2],center=true);
                cylinder(d=5,h=0.001);
                        ...
                        translate([0,-10,lm8uu_support_thickness])
            cylinder(d=5,center=true,h=10);
            for(j=[-1,1])
                translate([13*j,0,1.6]){
                cylinder(d=3.2,h=20,center=true);
	cylinder(r=m3_nut_diameter/2-0.3 /*tight*/ ,h=3.4,center=true,$fn=6);                }
 ...
 *holder_b();  
   ...
   module holder_c(){
    ...
    difference(){
     minkowski(){
            cube([33.4+10,10,lm8uu_support_thickness*2],center=true);
                cylinder(d=5,h=0.001);
            }
            for(j=[-1,1])
                translate([33.4/2*j,0,1.6]){
                cylinder(d=3.2,h=20,center=true);
	cylinder(r=m3_nut_diameter/2-0.3 /*tight*/ ,h=3.4,center=true,$fn=6);                }
        }
    }      
...
//			belt_support_offset=25+17.5;
	...
	for(i=[-1,1])
translate([28*i,0,15/2+lm8uu_support_thickness])
rotate(a=90,v=[1,0,0])
cylinder(d=15,h=80,center=true);
		...
		//rotate(hole*22)
		translate([0,25,-1])
		cylinder(r=m4_diameter/2,h=lm8uu_support_thickness*2+20,$fs=1);
		...
		*cable_tie_holes();
                        translate([0,-25,1*lm8uu_support_thickness])
            //rotate(a=180,v=[0,1,0])
            for(i=[-1,1])
                translate([12*i,-1.5,-17.2]){
                    cube([6.5,3.5,40],center=true);
                    #translate([0,13,22])
                    rotate(a=90,v=[1,0,0])
                    cylinder(d=4,h=20);
                }
